...
namespace MicroCredit.Controllers
{
    ...
    public class LoanController : ControllerBase
    {
        ...
        {
            var userIdClaim = User.Claims.FirstOrDefault(c => c.Type == "Id")?.Value; // Use "Id" instead of "UserId"
        ...
        public async Task<IActionResult> UpdateLoan(Guid id, [FromBody] LoanStatusUpdate loanStatusUpdate)
        {
            ...
            var existingLoan = await _context.Loans.FirstOrDefaultAsync(l => l.Id == id && l.UserId == userId);
        ...
        public async Task<IActionResult> CreateLoan([FromBody] Loan loan)
        {
            ...
            _logger.LogInformation("Authenticated User ID: {UserId}", userId);
            _logger.LogInformation("Loan User ID in Request: {LoanUserId}", loan.UserId);
