...
namespace MicroCredit.Controllers
{
        ...
        ControllerBase
    {
        ...
        {
            _logger.LogInformation("Fetching loans for the current user.");
            try
            {
            ...
            {
                _logger.LogError(ex, "Error fetching user loans.");
                return StatusCode(500, "Error fetching user loans.");
            }
        }
        [HttpPost("next")]
